...
class Arbiter:
    def __init__(self, logger: Logger, lattice_endpoint: str, environment_token: str, sandboxes_token: Optional[str] = None):
        self.logger = logger
        self.entity_handler = EntityHandler(logger, lattice_endpoint, environment_token, sandboxes_token)
        self.cache_manager = CacheManager()
        self.tasker = Tasker(logger, lattice_endpoint, environment_token, sandboxes_token)

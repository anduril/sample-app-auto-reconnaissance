...
class Arbiter:
    def __init__(self, logger: Logger, lattice_endpoint: str, client_id: str, client_secret: str, sandboxes_token: Optional[str] = None):
        self.logger = logger
        self.entity_handler = EntityHandler(logger, lattice_endpoint, client_id, client_secret, sandboxes_token)
        self.cache_manager = CacheManager()
        self.tasker = Tasker(logger, lattice_endpoint, client_id, client_secret, sandboxes_token)
